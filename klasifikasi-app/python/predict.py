...
# Dapatkan path folder ini (python/)
BASE_DIR = os.path.dirname(os.path.abspath(__file__))

# Path ke model dan file lainnya
model_path = os.path.join(BASE_DIR, 'knn_best_model.pkl')
feature_names_path = os.path.join(BASE_DIR, 'feature_names.npy')
